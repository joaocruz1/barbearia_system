...
export default function AppointmentsPage() {
  ...
  const {
    ...
    return appointmentsApi.getAll({ startDate, endDate, status: statusFilter || undefined })
  ...
  }, [newAppointment, clients, services, locations, createAppointment, refetchAppointments])
  ...
  const handleRescheduleAppointment = useCallback((appointment: Appointment) => {
    console.log("🔄 handleRescheduleAppointment chamado para:", appointment.client.name)
                ...
                <DialogContent className="max-w-lg bg-card border shadow-lg">
                  ...
                  <div className="grid gap-6 py-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <Select onValueChange={handleBarberChange} value={newAppointment.barberId}>
                    ...
                    {/* Client selection */}
                    <div className="space-y-3">
                      <Label htmlFor="client" className="text-sm font-medium text-card-foreground">
                        Cliente *
                      </Label>
                      <Select onValueChange={handleClientChange} value={newAppointment.clientId}>
                        <SelectTrigger className="h-10 bg-background border-border focus:border-primary focus:ring-ring">
                    ...
                    <div className="space-y-3">
                      ...
                      <Select onValueChange={handleServiceChange} value={newAppointment.serviceId}>
                        <SelectTrigger className="h-10 bg-background border-border focus:border-primary focus:ring-ring">
                    ...
                    {/* Payment method */}
                    <div className="space-y-3">
                      <Label htmlFor="payment" className="text-sm font-medium text-card-foreground">
                        Método de Pagamento
                      </Label>
                      <Select onValueChange={handlePaymentMethodChange} value={newAppointment.paymentMethod}>
                        <SelectTrigger className="h-10 bg-background border-border focus:border-primary focus:ring-ring">
