...
export default function AppointmentsPage() {
  ...
  const {
    ...
    // Só buscar agendamentos se tivermos o barberId definido
    if (!barberId) {
    ...
    return appointmentsApi.getAll({
      ...
      // Sempre filtrar por barbeiro na visão individual (mesmo para admin)
      barberId: barberId,
    });
  }, [weekDates, statusFilter, isAdmin, barberId]);
  ...
  const handleCreateAppointment = useCallback(async () => {
    ...
    if (dateError || timeError) {
      toast.error("Erro", {
        description: "Corrija os erros nos campos de data e horário",
      });
      return;
    }
