...
import { Plus, Edit, Trash2, Clock, DollarSign, Search, Filter } from "lucide-react"
...
export default function ServicesPage() {
  ...
  // Mutations
  const { mutate: createService, loading: creatingService } = useMutation((data: CreateServiceData) =>
    servicesApi.create(data),
  )

  const { mutate: updateService, loading: updatingService } = useMutation(({ id, data }: { id: string; data: any }) =>
  ...
  const { mutate: deleteService, loading: deletingService } = useMutation(async (id: string) => {
  ...
  const handleUpdateService = async () => {
    ...
    if (!editService.name || !editService.price || !editService.durationMinutes) {
      toast.error("Erro", {
        description: "Nome, preço e duração são obrigatórios",
      })
      return
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        <header className="flex h-16 shrink-0 items-center gap-2 border-b border-gray-200 px-4 bg-white">
          ...
          <h1 className="text-lg font-semibold text-black">Gerenciar Serviços</h1>
        </header>
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Preencha as informações do novo serviço oferecido pela barbearia.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => setNewService({ ...newService, isActive: value === "true" })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => setEditService({ ...editService, isActive: value === "true" })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleUpdateService} disabled={updatingService}>
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Tem certeza que deseja excluir o serviço "{editingService?.name}"? 
